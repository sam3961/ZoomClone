...
public class App extends Application {
    //App credentials
    private static final String APPLICATION_ID = "86001";
    private static final String AUTH_KEY = "3V54Dhaw6mCx979";
    private static final String AUTH_SECRET = "J5Tr3FBLqPwqPLP";
    private static final String ACCOUNT_KEY = "7X-ZHzUeDf1cCT8AhUmL";
